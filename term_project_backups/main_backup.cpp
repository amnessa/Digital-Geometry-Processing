...
void visualizeFarthestPointSampling();
void testRigidityAnalysis();
void visualizeIsocurves();
void runSegmentationAlgorithm();
 ...
 */
void displayMenu() {
    cout << "\n=== Pairwise Harmonics Segmentation Tool ===" << endl;
    cout << "1. Load mesh from file" << endl;
    cout << "2. Test pairwise harmonic computation" << endl;
    cout << "3. Compute and visualize farthest point sampling" << endl;
    cout << "4. Test rigidity analysis on skeletal segments" << endl;
    cout << "5. Visualize isocurves from harmonic field" << endl;
    cout << "6. Run complete segmentation algorithm" << endl;
    cout << "7. Exit" << endl;
